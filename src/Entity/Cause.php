...
class Cause
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CauseType", inversedBy="causes")
     * @ORM\JoinColumn(name="causetype_id", referencedColumnName="id", onDelete="SET NULL")
     */
    private $causetype;

    /**
     * @ORM\OneToMany(targetEntity="Report", mappedBy="primaryCause")
     */
    private $primaryReports;

    /**
     * @ORM\OneToMany(targetEntity="Report", mappedBy="secondaryCause")
     */
     ...
     * Set causetype
     *
     * @param \App\Entity\CauseType $causetype
     *
     * @return Cause
     */
    public function setCauseType(\App\Entity\CauseType $causetype = null)
    {
